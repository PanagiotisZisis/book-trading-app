...
$(document).ready(function() {
  ...
  function getAllBooks() {
    ...
    $.ajax({
      type: 'GET',
      url: 'https://booktradingapp.herokuapp.com/api/allBooks'
    }).done(function(data) {
      $('#allBooks').html('');
  ...
  $('#addBookButton').click(function() {
    ...
    $.ajax({
      type: 'GET',
      url: 'https://booktradingapp.herokuapp.com/api?title=' + searchTerm,
    }).done(function(books) {
      if (books.hasOwnProperty('error')) {
        ...
        $('.addToCollection').click(function() {
          ...
          $.ajax({
            type: 'POST',
            url: 'https://booktradingapp.herokuapp.com/api',
  ...
  $('#allBooks').on('click', '.requestTrade', function() {
    ...
    $.ajax({
      type: 'POST',
      url: 'https://booktradingapp.herokuapp.com/api/trade',
      contentType: 'application/json',
